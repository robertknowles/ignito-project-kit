...
import { PortalSidebar, PORTAL_SIDEBAR_WIDTH } from './PortalSidebar'
 ...
 * PortalSidebar renders position:fixed at PORTAL_SIDEBAR_WIDTH; offset the
 * content to match.
 */
  ...
  return (
    <div className="main-app flex h-screen w-full bg-white">
      ...
      <div
        ...
        style={{ marginLeft: `${PORTAL_SIDEBAR_WIDTH}px` }}
      >
        <Outlet />
      </div>
    </div>
