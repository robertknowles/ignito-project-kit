        ...
        <div className="flex items-center gap-4 flex-shrink-0 ml-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-[576px] appearance-none cursor-pointer bg-gray-200 rounded-full h-1 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-sm [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-[#2563EB] [&::-moz-range-thumb]:h-3 [&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-white [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:shadow-sm [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-[#2563EB]"
              style={{ background: `linear-gradient(to right, #2563EB 0%, #2563EB ${((snapshotYear - startYear) / (endYear - startYear)) * 100}%, #E5E7EB ${((snapshotYear - startYear) / (endYear - startYear)) * 100}%, #E5E7EB 100%)` }}
            />
